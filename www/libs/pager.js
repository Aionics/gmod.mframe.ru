...
// page-href
    ...
    (freeWindow || freeSelf || {}).Pager = pagerJsModule;
    ...
    // Check for `exports` after `define` in case a build optimizer adds an `exports` object.
      ...
      // Export for Node.js.
      if (moduleExports) {
        (freeModule.exports = pagerJsModule).Pager = pagerJsModule;
      }
      // Export for CommonJS support.
      freeExports.Pager = pagerJsModule;
    }
    else {
      // Export to the global object.
      root.Pager = pagerJsModule;
    }
}(window));
